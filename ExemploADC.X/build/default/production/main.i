...
void main (void){
 ...
 while(1){
  ValorADC = LerADC();
        ...
        StringLCD("Valor ADC: ");
        PosicionaLCD(1,13);
  EscreveLCD((ValorADC/1000)%10 + 48);
  EscreveLCD((ValorADC/100)%10 + 48);
  EscreveLCD((ValorADC/10)%10 + 48);
  EscreveLCD(ValorADC%10 + 48);

        PosicionaLCD(2,1);
        StringLCD("Convertido: ");
        PosicionaLCD(2,13);

        ValorTemp = ((ValorADC*5.0)/1024)*200;

        EscreveLCD((ValorTemp/100)%10 + 48);
